                ...
                <div class="row">
                    <div data-scrollreveal="wait 0.5s and then ease-in-out 50px" class="col-md-6 col-md-offset-3">
                        ...
                        <div class="align-center">
                            <h2 class="main-text">MARÍTIMA</h2>
                        ...
                        <div class="align-center">
                            <div class="col-md-12 align-center">
                                <div class="hi-icon-effect-9 hi-icon-effect-9a">
                                    <a href="index.jsp" class="hi-icon  hi-icon-screen" title="Homepage"></a>
                                    <a href="AgentesReceptores.jsp" class="hi-icon  hi-icon-user" title="Agentes Receptores"></a>
                                    <a href="Cargas.jsp" class="hi-icon  hi-icon-archive" title="Cargas"></a>
                                    <a href="Navios.jsp" class="hi-icon hi-icon-support" title="Navios"></a>
                                    <a href="Rotas.jsp" class="hi-icon hi-icon-contract" title="Rotas"></a>
                                    <a href="Portos.jsp" class="hi-icon hi-icon-location" title="Portos"></a>
                                </div>
                                <br />
